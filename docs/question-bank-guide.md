...
- **Status**: `active` (идэвхтэй), `archived` (идэвхгүй), `deleted` (устгасан - систем харуулахгүй).
...
Editor нь системд бүрэн React component хэлбэрээр хийгдсэн бөгөөд `sheets-action.ts`-ээр дамжуулан Google Sheets болон Google Drive-тай харьцдаг.

### Үндсэн функцууд:
- **Direct Sheet Integration**: Google Sheets API v4 ашиглан өгөгдлийг шууд унших/бичих (Service Account).
- **Image Optimization**: Зургийг автоматаар багасгаж (compress) Google Drive руу хуулна. Олсон public link-ийг Sheet-д хадгална.
...
1. **Environment Variables**: `.env.local` дотор `GOOGLE_SHEET_ID`, `GOOGLE_DRIVE_FOLDER_ID`, болон `FIREBASE_ADMIN_SERVICE_ACCOUNT_KEY_BASE64` тохируулагдсан байх шаардлагатай.
